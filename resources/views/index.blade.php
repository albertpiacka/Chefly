            ...
            <div class="posts" data-aos="fade-up">
                {{-- @foreach ($posts as $post)
                    <div class="post">
                        ...
                        <h2 class="headings-primary-light text-left">{{$post->title}}</h2>
                ...
                <div class="post">
                    ...
                    <h2 class="headings-primary-light text-left"><a href="/posts/{{$posts[0]->id}}">{{$posts[1]->title}}</a></h2>
                    <p class="text-left">{{$posts[0]->text}}</p>
                    <small>{{$posts[0]->user->name}}</small>
                </div>
                ...
                <div class="post">
                    ...
                    <h2 class="headings-primary-light text-left"><a href="/posts/{{$posts[1]->id}}">{{$posts[1]->title}}</a></h2>
                    <p class="text-left">{{$posts[1]->text}}</p>
                    <small>{{$posts[1]->user->name}}</small>
                </div>
